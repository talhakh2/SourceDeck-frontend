...
import { Eye, EyeOff, Mail, Lock, User, ArrowRight, ShoppingBag, TrendingUp, Search, Target, CheckCircle } from 'lucide-react';
  ...
  const handleManualSignup = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (result.success) {
        ...
        router.push(`/auth/verify-email?role=Buyer&email=${encodeURIComponent(formData.email)}`);
      } else {
        if (result.errors && result.errors.length > 0) {
          setValidationErrors(result.errors);
        } else {
      ...
      <div className="max-w-4xl w-full space-y-8">
        ...
        <div className="text-center">
          ...
          <p className="mt-2 text-sm text-gray-600">
            Access premium research and insights from expert sellers
          </p>
        </div>
        ...
        <div className="bg-white rounded-lg shadow-lg p-8">
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <textarea
                    ...
                    rows={3}
                    className="input"
                    placeholder="Tell us about your business and research interests..."
                  />
                </div>
              </div>
          ...
          <div className="mt-8 pt-6 border-t border-gray-200">
            <h4 className="font-medium text-gray-900 mb-4">Why buy research on our platform?</h4>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <div className="flex items-start space-x-3">
                <Search className="h-6 w-6 text-blue-500 mt-1" />
                <div>
                  <h5 className="font-medium text-gray-900">Quality Research</h5>
                  <p className="text-sm text-gray-600">Access vetted, high-quality insights</p>
                </div>
              </div>
              <div className="flex items-start space-x-3">
                <Target className="h-6 w-6 text-green-500 mt-1" />
                <div>
                  <h5 className="font-medium text-gray-900">Save Time</h5>
                  <p className="text-sm text-gray-600">Skip months of research work</p>
                </div>
              </div>
              <div className="flex items-start space-x-3">
                <TrendingUp className="h-6 w-6 text-purple-500 mt-1" />
                <div>
                  <h5 className="font-medium text-gray-900">Make Better Decisions</h5>
